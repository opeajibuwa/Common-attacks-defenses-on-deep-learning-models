...
"""# the differentially private training process for ResNet18 on CIFAR-10 dataset
MAX_GRAD_NORM = 1.2
EPSILON = 10
DELTA = 1e-5
EPOCHS = 30
...
train_dataset = datasets.CIFAR10(root="./datasets/", train=True, download=False, transform=train_transforms)
...
"""""" # the differentially private training process for VGG16 on FMNIST dataset
